    ...
    return (
        <>
            <div className="welcomeUser">
                Pour bénéficier pleinement des services proposés sur ce portail, pensez à renseigner ou à
                mettre à jour régulièrement vos données personnelles. Si vous choisissez par exemple de
                renseigner votre adresse de messagerie, vous pourrez recevoir votre nouveau mot de passe
                par courriel dans les minutes qui suivent votre demande de réinitialisation.
            </div>
            <Box sx={{ m: 2 }}>
                        ...
                        <Grow in style={{ transformOrigin: "0 0 0" }} timeout={800}>
                            <Grid item xs={8}>
                                ...
                                >
                                    ...
                                    <Button>
                                        Vous avez reçu un nouveau compte que vous souhaitez associer au
                                        compte ?
                                    </Button>
                                </Card>
                            </Grid>
